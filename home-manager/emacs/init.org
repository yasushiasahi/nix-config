...
[[https://qiita.com/nobuyuki86/items/e392b642189d755dd113#packageel][このような]]凝った設定もあるみたい。「built-inパッケージも更新対象にする」が気になる。
...
#+end_src
** 起動時に名言を表示する（ [[https://github.com/tkf/emacs-request][request]] HTTPクライアント）
#+begin_src emacs-lisp :tangle yes
