...
#+begin_src emacs-lisp
  ...
  ;;   (org-roam-setup))
#+end_src
** 第二の第二の脳 [[https://github.com/meedstrom/org-node][org-node]]
#+begin_src emacs-lisp :tangle yes
  (leaf org-node
    :ensure t
    ...
    (setopt org-node-data-dir "~/ghq/github.com/yasushiasahi/org/node")
    (setopt org-mem-watch-dirs (list org-node-data-dir))
