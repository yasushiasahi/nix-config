...
#+begin_src emacs-lisp :tangle yes
  (leaf eldoc-box
    ...
    (setopt eldoc-box-max-pixel-width 1200)
    (setopt eldoc-box-max-pixel-height 1050)
...
#+begin_src emacs-lisp :tangle yes
  (use-package apheleia
    :ensure t
    ;; :hook ((js-ts-mode typescript-ts-mode tsx-ts-mode nix-ts-mode astro-ts-mode terraform-mode toml-ts-mode yaml-ts-mode json-ts-mode) . apheleia-mode)
    ...
    ;; (add-hook 'astro-ts-mode-hook #'my/set-prettier-formatter)
