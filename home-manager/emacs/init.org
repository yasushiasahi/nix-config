...
#+begin_src emacs-lisp :tangle yes
  (use-package lsp-proxy
    ...
    :hook ((tsx-ts-mode js-ts-mode typescript-ts-mode astro-ts-mode nix-ts-mode html-ts-mode css-ts-mode toml-ts-mode json-ts-mode terraform-mode) . lsp-proxy-mode))
